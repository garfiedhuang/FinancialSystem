...
namespace Com.Garfield.Payment
{
    public partial class MainForm : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        ...
        {
            BillForm _billForm = new BillForm();
            _billForm.ID = -1;
        ...
        private void btnEdit_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            {
                MessageBox.Show("请选择要编辑的申请单！", "提示", MessageBoxButtons.OK);
                return;
            }
            else if (_lstTempHandle.Length > 1)
            {
                MessageBox.Show("只能选择一条申请单进行编辑！", "提示", MessageBoxButtons.OK);
                return;
            }
        ...
        private void btnDelete_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            {
                MessageBox.Show("请选择要删除的申请单！", "提示", MessageBoxButtons.OK);
                return;
            }
            if (MessageBox.Show("确定删除选中数据吗？", "提示", MessageBoxButtons.OKCancel) == DialogResult.OK)
            {
                BillBLL.DeletePaymentData(_lstID);
                //绑定数据源
                BindGridViewData();
            }
        }
        ...
        private void btnPrint_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            if (_lstID == null || _lstID.Count == 0)
            {
                MessageBox.Show("请选择要打印的申请单！", "提示", MessageBoxButtons.OK);
                return;
            }
        ...
        {
            var _dt = MainBLL.GetPaymentData();
